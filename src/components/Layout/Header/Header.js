...
const Header = () => {
    return (
        <header className="fixed--header__left">
            ...
            <button id="btnAddToItem" className="btn--add" type="button" onClick={Aside.foldingAside()}><span className="material-icons add-icons">add</span><span className="add-title">항목 추가 등록하기</span></button>
